...
<section class="section_home-header">
  ...
  <section class="home-initiationsbuttons">
    <div class="init-initiationsbuttons1">
    ...
    <div class="w-layout-blockcontainer init-initiationsbuttons2 w-container">
  ...
  <section class="home-initiations">
    <div class="container-9"></div>
    <div class="initiationsblock">
      ...
      <div class="dividerlineininitiations">---------------------------------------------------------</div><img src="images/location.png" loading="lazy" width="28" sizes="(max-width: 1279px) 28px, (max-width: 1439px) 2vw, (max-width: 1919px) 28px, 1vw" alt="" srcset="images/location-p-500.png 500w, images/location-p-800.png 800w, images/location.png 980w" class="location-image"><img src="images/data.png" loading="lazy" width="26" height="Auto" alt="" srcset="images/data-p-500.png 500w, images/data-p-800.png 800w, images/data.png 938w" sizes="(max-width: 767px) 26px, (max-width: 991px) 3vw, (max-width: 1279px) 26px, (max-width: 1439px) 2vw, (max-width: 1919px) 26px, 1vw" class="dataimage"><img src="images/time.png" loading="lazy" width="30" alt="" class="timeimage">
      <div class="text-block-6">Час</div>
      <div class="datatext">Дата</div>
      <div class="locationtext">Локація</div>
      <div class="locationtext">Локація</div>
      <a data-w-id="fa9b8b9e-9aec-152a-b28a-6e0d16756fe0" style="background-color:rgb(230,230,230)" href="#" class="moreaboutinitiation w-inline-block">
