...
{{--    </section>--}}
    <section class="hero-heading-center-15">
        <div class="form-block-copy w-form">
                <textarea placeholder="Опис збору" maxlength="5000" id="field" name="field" data-name="Field"
...
<input class="text-field-3 w-input"
                                                                                       maxlength="256" name="gatherName"
                                                                                       data-name="gatherName"
                                                                                       placeholder="Назва збору"
                                                                                       type="text"
                                                                                       id="gatherName"><input
                        class="text-field-4 w-input" maxlength="256" name="moneyGoal" data-name="moneyGoal"
                        placeholder="Грошова ціль" type="text" id="moneyGoal" required=""><input
                        class="text-field-5 w-input" maxlength="256" name="endDate" data-name="endDate"
                        placeholder="Дата закінчення збору" type="date" id="endDate" required=""><input
                        class="text-field-6 w-input" maxlength="256" name="details" data-name="details"
                        placeholder="Посилання на реквізити " type="text" id="details" required=""><input
                        class="text-field-7 w-input" maxlength="256" name="hashTags" data-name="hashTags"
                        placeholder="Додайте хеш-теги" type="text" id="hashTags" required=""><select id="status"
                                                                                                     name="status"
                                                                                                     data-name="status"
