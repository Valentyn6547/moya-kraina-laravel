...
@section('content')
    ...
    <section class="personalinfopart">
        ...
        <a data-w-id="595d9041-4d0f-a934-abb5-0c6fe48f8dd8" href="#" class="resetpasswordbutton w-inline-block">
            <div data-w-id="595d9041-4d0f-a934-abb5-0c6fe48f8dd9" style="color:rgb(0,0,0)" class="button2-text">
                Відновити пароль
            </div>
            <div data-w-id="595d9041-4d0f-a934-abb5-0c6fe48f8ddb"
    ...
    <section class="initiationsheaderpart">
        ...
        <a data-w-id="9fdc8d8e-f3e7-bda1-fd40-bbbda0d66400" href="createinitiation.html"
