...
<section class="section_big">
    <div class="checkemailmodal w-form">
        <form action="{{ route('password.update') }}" method="post" class="checkemailform" data-wf-page-id="664260aa8f1dc90265240c56" data-wf-element-id="f0e6b0ee-06e7-173f-4bf9-f99e3b6c89ab">
            @csrf
