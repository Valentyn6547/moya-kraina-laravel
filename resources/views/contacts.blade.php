...
.padding-vertical {
  ...
  <section class="hero-heading-center-16">
    <div class="container-11">
      <h1 class="centered-heading-7 margin-bottom-32px">Зв&#x27;яжіться з нами !</h1>
    </div>
  </section>
  <section class="hero-heading-center-17-copy">
    ...
    <div class="contact_form-wrapper w-form">
      <form id="email-form-2" name="email-form-2" data-name="Email Form 2" method="get" class="contact_form" data-wf-page-id="6600170fbaf6f29ff2cfa05d" data-wf-element-id="a77d14c5-5cf4-46f1-9f58-ef8a8705f5d3">
        <div class="contact_form-grid">
          ...
          <div id="w-node-a77d14c5-5cf4-46f1-9f58-ef8a8705f5e5-f2cfa05d" class="form_field-wrapper"><label for="field-3">Повідомлення</label><textarea placeholder="Ваше повідомлення..." maxlength="5000" id="field-2" name="field-2" data-name="Field 2" class="form_input is-text-area w-input"></textarea></div>
        </div>
